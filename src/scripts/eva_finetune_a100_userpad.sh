...
DATA_PATH="${WORKING_DIR}/data/debtcollection_usertag" # path of the directory of the dataset
CACHE_PATH="${DATA_PATH}/.cache_en256_de64"
ENC_LEN=256 # max input length of encoder
DEC_LEN=64 # max input length of decoder

CKPT_PATH="${WORKING_DIR}/../eva2.0"
# SAVE_PATH="${WORKING_DIR}/results/debtcollection_usertag_en256_de64/finetune/"
# save to autodl nas
SAVE_PATH="/root/autodl-nas/EVA/results/debtcollection_usertag_en256_de64/finetune/"
